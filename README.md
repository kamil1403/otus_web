...
- [x] Проверка пройдена. Результат см. на скриншоте 🖼️ ["kernel_update.png"](https://github.com/kamil1403/otus_vagrant/blob/main/screenshots/otus_vagrant_1.png)
...
* Настройка Nginx: удаляет дефолтный конфиг, заливает новый.     
